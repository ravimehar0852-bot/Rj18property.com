/* ============================================================
   RJ18 PROPERTY DEALER — Shared Script
   ============================================================ */

const PHONE = "919056218327"; // WhatsApp format (no +, no leading 0)
const PHONE_DISPLAY = "+91 90562 18327";
...
function buildWhatsAppLink(message) {
  const text = encodeURIComponent(
    message || "Hello RJ18 Property Dealer, I am interested in a property. Please share available options."
  );
...
function buildFormMessage(type, data) {
  ...
  if (type === "buy") {
    return `Hello RJ18 Property Dealer, I am looking to buy a property.\nName: ${get("name")}\nPhone: ${get("phone")}\nLocation: ${get("location")}\nProperty Type: ${get("propertyType")}\nBudget: ${get("budget")}\nRequirement: ${get("requirement")}`;
  }
  if (type === "sell") {
    return `Hello RJ18 Property Dealer, I want to sell my property.\nOwner Name: ${get("ownerName")}\nPhone: ${get("phone")}\nProperty Type: ${get("propertyType")}\nLocation: ${get("location")}\nArea: ${get("area")}\nExpected Price: ${get("price")}\nDetails: ${get("details")}`;
  }
  if (type === "enquiry") {
    return `Hello RJ18 Property Dealer, I have a property enquiry.\nName: ${get("name")}\nPhone: ${get("phone")}\nPreferred Location: ${get("location")}\nProperty Type: ${get("propertyType")}\nBudget: ${get("budget")}\nBuy/Sell: ${get("purpose")}\nMessage: ${get("message")}`;
  }
  if (type === "contact") {
    return `Hello RJ18 Property Dealer, I would like to get in touch.\nName: ${get("name")}\nPhone: ${get("phone")}\nEmail: ${get("email")}\nRequirement: ${get("requirement")}\nLocation: ${get("location")}\nMessage: ${get("message")}`;
  }
  return "Hello RJ18 Property Dealer, I am interested in a property.";
}
